...
public class HelloController {
    ...
    @GetMapping("/greeting")
    String greeting(@RequestParam(name="firstname", required = false, defaultValue = "World") String name,
    ...
    @GetMapping("/concat")
    String concat(@RequestParam(name="first", required = false, defaultValue = "") String first,
